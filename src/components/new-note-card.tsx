                ...
                <form className="flex-1 flex flex-col"> 
                    <div className="flex flex-1 flex-col gap-3 p-5">
                        ...
                        {shouldShowOnboarding ? (
                            ...
                            <textarea 
                                autoFocus 
                                className="text-md leading-6 text-slate-400 bg-transparent resize-none flex-1 outline-none"
                    ...
                    {IsRecording ? (
                        ...
                        className="w-full flex item-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm font-medium text-slate-300 outline-none hover:text-slate-100" 
                    >
